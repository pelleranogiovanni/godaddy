		...
		<div class="row">
			...
			<div class="col-md-6 border-top">
				...
				<div class="div border-bottom">
					<p><i class="fas fa-home text-secondary"></i> Domicilio</p>
					<p><i class="fas fa-envelope text-secondary"></i> cooperativa@hotmail.com</p>
					<p><i class="fas fa-phone text-secondary"></i> 03735 - xxxxxx</p>
				</div>
				...
				<div class="div mt-3 mb-5">
					<h3 class="text-uppercase text-left">Ubicación</h3>
					    ...
					    <div class="card-text">
					    	...
					    	<iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d14144.777433378571!2d-60.72438138022462!3d-27.587503299999995!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses!2sar!4v1529760019758" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
